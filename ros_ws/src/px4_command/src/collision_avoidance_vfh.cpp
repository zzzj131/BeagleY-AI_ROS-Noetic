...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber lidar_sub = nh.subscribe<sensor_msgs::LaserScan>("/scan", 10, scan_cb);
   ...
   // pose.pose.position.z = 2;
	...
	//setpoint_raw.position.x = init_position_x -6;
	//setpoint_raw.position.y = init_position_y -6;
	...
	/*    printf("init_position_x = %f",init_position_x);
	   ...
	   printf("  u1.vt = %f",u1.vt);
		...
		//vel_msg.linear.x  = u1.vt;
		//vel_msg.angular.z = u1.ot;
